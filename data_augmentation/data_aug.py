...
def central_scale_images(X_imgs, scales,IMAGE_SIZE,CH):
    ...
    r = randrange(len(X_scale_data))
    return X_scale_data[r]
...
def translate_images(X_imgs,IMAGE_SIZE,CH):
    ...
    r = randrange(len(X_translated_arr))
    return X_translated_arr[r]
